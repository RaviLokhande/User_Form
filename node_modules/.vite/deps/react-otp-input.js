import {
  init_compat_module,
  wn
} from "./chunk-TBOC64JQ.js";
import "./chunk-PPTOAE6Z.js";
import "./chunk-WZHKJ3SU.js";
...
var OTPInput = function(_a) {
  ...
  var _f = wn.useState(0), activeInput = _f[0], setActiveInput = _f[1];
  var inputRefs = wn.useRef([]);
  ...
  return wn.createElement("div", { style: Object.assign({ display: "flex", alignItems: "center" }, isStyleObject(containerStyle) && containerStyle), className: typeof containerStyle === "string" ? containerStyle : void 0 }, Array.from({ length: numInputs }, function(_, index) {
    return index;
  }).map(function(index) {
    var _a2, _b2, _c2;
